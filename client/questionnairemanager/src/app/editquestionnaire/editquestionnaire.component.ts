          ...
          removeOption(i: number, j: number): void {
            ...
            onSubmit(){
              ...
              this.userapi.findById(this.loopbackauth.getCurrentUserId()).subscribe((data)=>{
                  ...
                  this.questionnaireapi.patchAttributes(this.id, model).subscribe((data)=>{
                        this._flashMessagesService.show('The Questionnaire data has been Updated Successfully! ', { cssClass: 'alert-success', timeout: 3000 });
